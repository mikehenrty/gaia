...
(function(exports) {
  ...
  /**
   * NotificationTray manages notifications in the bottom tray
   */
  var NotificationTray = {
    ...
    handleEvent: function(evt) {
      switch (evt.type) {
        ...
        case 'touchend':
          this.endSlide(evt.changedTouches[0].pageY);
          break;
      }
    },
    ...
    add: function(detail) {
      ...
      if (oldNotif) {
        // The whole node cannot be replaced cuz CSS animations are re-started
        ...
        notificationNode.addEventListener('touchend', function(evt) {
          this.endNotificationSlide(evt.currentTarget,
  ...
  exports.NotificationTray = NotificationTray;
}(window));
